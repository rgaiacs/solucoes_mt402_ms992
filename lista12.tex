...
\newcommand{\mycheader}{Lista 12 - Pseudoinversa}
...
\begin{questions}
    ...
    \begin{parts}
        \part a solu\c{c}\~{a}o de quadrados m\'{i}nimos de norma-2 m\'{i}nima \'{e} $\overline{x} = \sum_{i = 1}^r (\sigma_i)^{-1} u_i^t b v_i$,
        \begin{solution}
            Temos que
            \begin{align*}
