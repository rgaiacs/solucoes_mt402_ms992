...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            Quando consideramos a Hermitiana de $A$, temos que $A = A^*$ e conseguentemente $a_{ii} \in \mathbb{R}$. Logo, considerando a Hermitiana de $A$ \'{e} correto $\mbox{tr}(A) = \mbox{tr}(A^*)$.
        \end{solution}
    ...
    \question
    \begin{parts}
        \part Considere a matriz $I_n + u v^t$, com $u, v \in \mathbb{R}^n$ e $1 + v^t u \neq 0$. Verifique (por multiplica\c{c}\~{a}o direta), que $(I + u v^t)^{-1} = I - \frac{u v^t}{u v^t + 1}$.
        \begin{solution}
            \begin{align*}
                \left( I + u v^t \right) \left( I - \frac{u v^t}{u v^t + 1} \right) &= I - \frac{u v^t}{u v^t + 1} + u v^t - \frac{u v^t u v^t}{u v^t + 1} \\
                &= I + \frac{- u v^t + \left( u v^t + 1 \right) u v^t - u v^t u v^t}{u v^t + 1} \\
                &= I + \frac{- u v^t + u v^t u v^t + u v^t - u v^t u v^t}{u v^t + 1} \\
                &= I.
            \end{align*}
        \end{solution}
        ...
        \begin{solution}
            Suponhamos que $\left( I - u v^t \right)^{-1} = I + \frac{u v^t}{- u v^t + 1}$, com $u, v \in \mathbb{R}^n$ e $\left( - u v^t + 1 \right) \neq 0$. Agora vamos verificar nossa suposi\c{c}\~{a}o por multiplica\c{c}\~{a}o direta.
            \begin{align*}
                \left( I - uv^t \right) \left( I + \frac{u v^t}{u v^t + 1} \right) &= I + \frac{u v^t}{- u v^t + 1} - u v^t - \frac{u v^t u v^t}{- u v^t + 1} \\
                &= I + \frac{u v^t + u v^t u v^t - u v^t + u v^t u v^t}{- u v^t + 1} \\
                &= I.
            \end{align*}
        \end{solution}
        ...
        \begin{solution}
            ...
            \[
            E^{-1} = I + \frac{\alpha e_i e_k^t}{- \alpha e_i e_k^t + 1}.
            \]
        \end{solution}
    \end{parts}
\end{questions}
