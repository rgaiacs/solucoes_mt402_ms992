...
\end{center}
Este trabalho encontra-se dispon\'{i}vel em \input{repository.tex} e atualmente precisa de um mantenedor, se tiver interessse entre em contato com Raniere Silva (\input{maintainer.tex}).
